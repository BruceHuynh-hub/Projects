...
Mux4x1::Mux4x1(bus& a, bus& b, bus& c, bus& d, bus& sel, bus& w) :
	i1(&a), i2(&b), i3(&c), i4(&d), i5(&sel), o1(&w)
{
	o1->fill('X');
}
...
Demux::Demux (bus& a, bus& b, bus& sel, bus& demuxOutA00, bus& demuxOutB00, bus& demuxOutA01, bus& demuxOutB01, bus& demuxOutA10, bus& demuxOutB10, bus& demuxOutA11, bus& demuxOutB11):
	in1(&a), in2(&b), insel(&sel), out1a(&demuxOutA00), out1b(&demuxOutB00), out2a(&demuxOutA01), out2b(&demuxOutB01), out3a(&demuxOutA10), out3b(&demuxOutB10), out4a(&demuxOutA11), 
	out4b(&demuxOutB11){
	out1a->fill('X');
	out1b->fill('X');
	out2a->fill('X');
